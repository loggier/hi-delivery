...
import { FormInput, FormSelect, FormFutureDatePicker, FormFileUpload, FormMultiImageUpload } from '@/app/deliveryman/apply/_components/form-components';
...
export function Step3_VehicleInfo() {
  ...
  const onSubmit = async (data: VehicleInfoFormValues) => {
    ...
    try {
      ...
      router.push(`/site/deliveryman/apply/policy-info?id=${riderId}`);
